...
const Aula13_Produto = ({ nome, preco, imagem, link, categoria, freteGratis, botaoExcluir, botaoEditar }) => {
    return (
        <div style={estilos.cardProduto}>
            ...
            <div style={{ padding: '5px' }}>
                ...
                <div style={{ marginTop: '10px' }}>
                    ...
                    <button style={estilos.botao} onClick={botaoExcluir}>Excluir</button>
                    <button style={estilos.botao} onClick={botaoEditar}>Editar</button>
                </div>
            </div>
        </div>
    )
